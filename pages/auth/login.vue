    ...
    <div class="row justify-content-center align-items-center authentication authentication-basic h-100">
      <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
        <div class="my-5 d-flex justify-content-center">
          <NuxtLink to='/'>
            <img src="https://logolook.net/wp-content/uploads/2021/06/Apple-Logo-2007.png" alt="logo" class="desktop-logo">
            <img src="https://logolook.net/wp-content/uploads/2021/06/Apple-Logo-2007.png" alt="logo" class="desktop-dark">
          </NuxtLink>
        </div>
        <div class="card custom-card">
          <div class="card-body p-5">
            <p class="h5 fw-semibold mb-2 text-center">Sign In</p>
            <p class="mb-4 text-muted op-7 fw-normal text-center">Welcome back Praveen !</p>
            <div class="row gy-3">
              <div class="col-xl-12">
              ...
              <div class="col-xl-12 d-grid mt-2">
                <NuxtLink @click.prevent="login" class="btn btn-lg btn-success">Sign In</NuxtLink>
              </div>
            </div>
            <div class="text-center">
              <p class="fs-12 text-muted mt-3">Don't have an account? <NuxtLink to="/authentication/sign-up/basic"
                  class="text-success">Sign Up</NuxtLink>
              </p>
            </div>
